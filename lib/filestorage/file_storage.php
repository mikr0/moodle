...
class file_storage {
    ...
    public function cron() {
        ...
        // Remove row from {files_reference} without any link/usage in {files} and lastsync older than 7 days
        ...
        $sql = "SELECT p.*
            ...
            WHERE
                o.id IS NULL
                AND DATEDIFF(NOW(), DATE_FORMAT(FROM_UNIXTIME(p.lastsync), '%Y-%m-%d %H:%i:%s')) > 7";
